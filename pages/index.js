...
${(ctx?.marca?.nombre||"").toLowerCase().includes("turbochef")?"TurboChef HHC errores: F1=blower failure (BMSC CON-7013); F2=temp baja en coccion (no para); F4=emergency stop (contador); F5=camara sobrecalentada (limpiar grasa); F6=compartimiento electrico caliente (ventilacion, 254mm arriba 51mm lados); F7=RTD failure (999F=desconectado, 100ohm@0C); F8=high limit tripped (limpiar grasa); F9=over temp >650F (no para). TEST MODE password: 2433.":""}
