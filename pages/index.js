...
const EQUIPOS = [
  { tipo:"Horno", icon:"🔥", marcas:[
    { nombre:"Rational", refs:[
      { ref:"SCC WE 61G",         favorito:false, img:"https://images.tundrafmp.com/fit-in/700x700/filters:fill(white)/product_images/original_images/RATIONAL-iCombi-Pro-10-11-E_main.jpg", desc:"SelfCookingCenter 6×1/1 GN · Gas" },
      { ref:"SCC WE 101G",        favorito:false, img:"https://images.tundrafmp.com/fit-in/700x700/filters:fill(white)/product_images/original_images/RATIONAL-iCombi-Pro-10-11-E_main.jpg", desc:"SelfCookingCenter 10×1/1 GN · Gas" },
      { ref:"SCC XS 6 2/3 E",     favorito:true,  img:"https://www.metos.com/media/catalog/product/r/a/rational_icombi_pro_xs_6_2_3_electric_1.jpg",  desc:"iCombi XS · 6×2/3 GN · Eléctrico · Compacto" },
      { ref:"SCC XS UV Plus",     favorito:false, img:"https://www.metos.com/media/catalog/product/r/a/rational_icombi_pro_xs_6_2_3_electric_1.jpg",  desc:"iCombi XS UV Plus · 6×2/3 GN · Conexión red" },
    ]},
    { nombre:"Unox", refs:[
      { ref:"XECC-0523-EPRM",     favorito:true,  img:"https://www.partstown.com/content/dam/partstown/product-images/UNOX/UNOX-XECC-0523-EPRM.jpg",   desc:"ChefTop MIND.Maps PLUS Compact · 5×GN 2/3 · Eléctrico" },
      { ref:"XEFT-04HS-ELDV",     favorito:true,  img:"https://exhibirequipos.com/wp-content/uploads/2021/06/UNOX-XEFT-04HS-ELDV.jpg",                   desc:"Arianna BakerLux Shop.Pro LED · 4×460×330 · 3.5 kW" },
      { ref:"XEFR-04HS-ELDV",     favorito:false, img:"https://exhibirequipos.com/wp-content/uploads/2021/06/UNOX-XEFT-04HS-ELDV.jpg",                   desc:"Arianna BakerLux Shop.Pro LED · con vapor" },
      { ref:"XEVC-0511-GPRM",     favorito:false, img:"https://www.unox.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/x/e/xevc-0511-gprm.jpg", desc:"ChefTop MIND.Maps ONE · 5×GN 1/1 · Gas" },
    ]},
    { nombre:"Zanolli", refs:[
      { ref:"Synthesis 08/50 Gas", favorito:false, img:"https://www.cfreddo.com/cdn/shop/products/synthesis-08-50-v-pw-gas-pizza-tunnel-oven_1200x.jpg", desc:"Horno túnel pizza · banda 50 cm · Gas" },
      { ref:"Synthesis 06/40 Gas", favorito:false, img:"https://www.cfreddo.com/cdn/shop/products/synthesis-08-50-v-pw-gas-pizza-tunnel-oven_1200x.jpg", desc:"Horno túnel pizza · banda 40 cm · Gas" },
    ]},
    { nombre:"Turbochef", refs:[
      { ref:"HHC2020",  favorito:false, img:"https://www.partstown.com/content/dam/partstown/product-images/TURBOCHEF/TURBOCHEF-HHC2020.jpg",  desc:"High h Conveyor 2020 · Alta velocidad · Ventless" },
      { ref:"HHC1618",  favorito:false, img:"https://turbochef.com/wp-content/uploads/2019/07/HhC-1618_front.jpg",                              desc:"High h Conveyor 1618 · Alta velocidad · Ventless" },
    ]},
  ]},
  ...
  return (
    <div style={{padding:20,overflowY:"auto",height:"calc(100vh - 110px)"}}>
      ...
      <div style={{textAlign:"center",padding:"14px 0 6px",borderTop:`1px solid ${C.border}`,marginTop:6,fontSize:10,color:C.light}}>
        ...
        <span style={{fontSize:9}}>{process.env.NEXT_PUBLIC_BUILD_DATE ? "v3.1 · " + new Date(process.env.NEXT_PUBLIC_BUILD_DATE).toLocaleDateString("es-CO",{day:"2-digit",month:"2-digit",year:"2-digit"}) + " " + new Date(process.env.NEXT_PUBLIC_BUILD_DATE).toLocaleTimeString("es-CO",{hour:"2-digit",minute:"2-digit"}) : "v3.1 · dev"}</span>
      </div>
    </div>
  );
}
